...
public class JmeterFromCode {
    ...
    public static void main(String [] arg) throws Exception {
        ...
        // Jmeter location
        File jmeterHome = new File("/Users/Shared/SOFTWARE/MIDDLEWARE/apache-jmeter-5.3" /*System.getProperty("jmeter.home", "apache-jmeter-4.0")*/);
        ...
        if (jmeterHome.exists()) {
            ...
            if (jmeterProperties.exists()) {
                ...
                csvDataSet.setProperty("filename", "/Users/Shared/MIDDLEWARE/MIDDLEWARE_EVOLUTION/data.csv");
